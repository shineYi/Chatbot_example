...
namespace GreatWall
{
    ...
    public class RootDialog : IDialog<object>
    {
        ...
        private async Task MessageReceivedAsync(IDialogContext context, IAwaitable<object> result)
        {
            ...
            actions.Add(new CardAction() { Title = "1.주문", Value = "1번", Type = ActionTypes.ImBack });
            actions.Add(new CardAction() { Title = "2.FAQ", Value = "2번", Type = ActionTypes.ImBack });
        ...
        private async Task SendWelcomeMessageAsync(IDialogContext context, IAwaitable<object> result)
        {
            ...
            if (selected == "1" || selected == "1번")
            {
                context.Call(new OrderDialog(), DialogResumeAfter);
            }
            else if (selected == "2" || selected == "2번")
            {
